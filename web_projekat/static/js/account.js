			...
			if(this.name == ""){
			...
			else
				{
		      			...
		      			if(this.user.typeOfUser == 'Administrator')
		      				user = {typeOfUser:this.user.typeOfUser ,username: this.user.username, name : this.name, surname : this.surname, gender : this.gender, password : this.savedPassword};
		     
		        		 axios
			  				.put("/users/account", JSON.stringify(user))
